...
window.addEventListener("template-loaded", () => {
    ...
    if (switchBtn) {
        switchBtn.onclick = function () {
            ...
            switchBtn.querySelector("#theme-toggle").textContent = isDark ? "Dark mode" : "Light mode";
        };
        const isDark = localStorage.dark === "true";
        switchBtn.querySelector("#theme-toggle").textContent = isDark ? "Light mode" : "Dark mode";
    }
});
